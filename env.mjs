...
export const env = createEnv({
  server: {
    ...
    NEXT_PUBLIC_CHAIN_ID_MAINNET: z.enum(['1', '5', '137', '11155111']),
    NEXT_PUBLIC_BEEP_CONTRACT_ADDRESS_MAINNET: z.string().min(1).startsWith('0x'),
    NEXT_PUBLIC_BEEP_TBA_IMPLEMENTATION_ADDRESS_MAINNET: z.string().min(1).startsWith('0x'),
    NEXT_PUBLIC_REGISTRY_ADDRESS_MAINNET: z.string().min(1).startsWith('0x'),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_CHAIN_ID_MAINNET: process.env.NEXT_PUBLIC_CHAIN_ID_MAINNET,
    NEXT_PUBLIC_BEEP_CONTRACT_ADDRESS_MAINNET: process.env.NEXT_PUBLIC_BEEP_CONTRACT_ADDRESS_MAINNET,
    NEXT_PUBLIC_BEEP_TBA_IMPLEMENTATION_ADDRESS_MAINNET: process.env.NEXT_PUBLIC_BEEP_TBA_IMPLEMENTATION_ADDRESS_MAINNET,
    NEXT_PUBLIC_REGISTRY_ADDRESS_MAINNET: process.env.NEXT_PUBLIC_REGISTRY_ADDRESS_MAINNET,
