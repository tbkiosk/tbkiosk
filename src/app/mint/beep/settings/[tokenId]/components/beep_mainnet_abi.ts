export const abi = [
  ...
  },
  {
    ...
    name: 'GlobalBaseURIUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'bool', name: 'restriction', type: 'bool' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint256', name: 'newQuantity', type: 'uint256' }],
    name: 'QuantityPerClaimUpdated',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes', name: 'encryptedBaseURI', type: 'bytes' },
    ],
  ...
  {
    inputs: [{ internalType: 'string', name: '_globalBaseURI', type: 'string' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_saleRecipient', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'address', name: '_subscription', type: 'address' }],
