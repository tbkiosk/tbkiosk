...
import Ethereum from 'public/icons/tokens/ethereum-black.svg'
...
const Mint = () => (
  <>
    ...
    <main className="h-[100vh] max-w-screen-2xl mx-auto pt-[var(--header-height)] bg-white text-black overflow-hidden">
